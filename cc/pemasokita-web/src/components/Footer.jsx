...
export default function Footer() {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mt-10 w-[80%]`}>
        <div className="flex-1 flex flex-col justify-start">
          <h1 className={`${styles.heading2} text-[38px] text-white`}>
            PEMASOKITA
          </h1>
        ...
        <div className="flex-1 w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10">
          {footerLinks.map((footerlink) => (
            ...
            >
              ...
              <ul className="list-none mt-8 text-[#DEDEDE]">
